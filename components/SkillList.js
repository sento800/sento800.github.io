...
export default function SkillList() {
  ...
  return (
    <div className="h-lvh flex flex-1 items-center flex-col gap-36">
      <h1 id="skill" className="text-6xl text-center py-5 ">
      ...
      <motion.div
        ...
        className="flex-1"
      >
        <div className="py-5 flex font-bold gap-20 ">
          {/* next js */}
        ...
        <div className="mt-10 py-5 font-bold">
          <div className="w-48 h-48 bg-black flex flex-col justify-center items-center rounded-md border-2 border-black ">
            <div>
              <svg
                width="56"
