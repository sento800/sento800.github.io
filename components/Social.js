...
export default function Social() {
  return (
    <ul className="flex gap-8">
      <li>
        <Link href="https://www.facebook.com/phuhhhh5/">
          <Button magnetic="true" style="small">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
